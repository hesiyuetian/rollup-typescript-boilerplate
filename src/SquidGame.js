...
class GameTicket2 extends GameTicket {
    ...
    async getGameToken() { // 获取token（SQT）的信息
...
class GameTicketActivity extends GameTicket2 {
    constructor(provider, address) {
        super(provider, address)
    }
}

class GamePoolCS extends BaseInstance {
    constructor(provider, address, abi=null) {
        if(abi == null) {
...
class GamePool extends GamePoolCS {
    constructor(provider, address) {
        super(provider, address);
    }
...
class GamePoolActivity extends GamePoolCS {
    constructor(provider, address) {
        let abi = [{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"user","type":"address"},{"indexed":true,"internalType":"uint128","name":"orderId","type":"uint128"},{"indexed":false,"internalType":"uint128","name":"winAmount","type":"uint128"},{"indexed":false,"internalType":"uint128","name":"shareAmount","type":"uint128"}],"name":"Claimed","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_user","type":"address"},{"indexed":true,"internalType":"address","name":"_old","type":"address"},{"indexed":true,"internalType":"address","name":"_new","type":"address"}],"name":"ConfigChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"uint256","name":"_old","type":"uint256"},{"indexed":true,"internalType":"uint256","name":"_new","type":"uint256"}],"name":"FeeRateChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"uint128","name":"value","type":"uint128"}],"name":"NewRound","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_user","type":"address"},{"indexed":true,"internalType":"address","name":"_old","type":"address"},{"indexed":true,"internalType":"address","name":"_new","type":"address"}],"name":"OwnerChanged","type":"event"},{"anonymous":false,"inputs":[],"name":"Paused","type":"event"},{"anonymous":false,"inputs":[],"name":"Unpaused","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"to","type":"address"},{"indexed":true,"internalType":"uint256","name":"reward","type":"uint256"},{"indexed":false,"internalType":"address","name":"feeTo","type":"address"},{"indexed":false,"internalType":"uint256","name":"fee","type":"uint256"}],"name":"Withdrawed","type":"event"},{"inputs":[],"name":"admin","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"buyToken","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"buyTokenUnit","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_orderId","type":"uint128"}],"name":"canClaim","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"changeOwner","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint128","name":"_orderId","type":"uint128"}],"name":"claim","outputs":[{"internalType":"uint128","name":"winAmount","type":"uint128"},{"internalType":"uint128","name":"shareAmount","type":"uint128"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint128","name":"_start","type":"uint128"},{"internalType":"uint128","name":"_end","type":"uint128"}],"name":"claimAll","outputs":[{"internalType":"uint128","name":"winAmount","type":"uint128"},{"internalType":"uint128","name":"shareAmount","type":"uint128"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint128","name":"_start","type":"uint128"},{"internalType":"uint128","name":"_end","type":"uint128"}],"name":"claimAllForZero","outputs":[{"internalType":"uint128","name":"winAmount","type":"uint128"},{"internalType":"uint128","name":"shareAmount","type":"uint128"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"config","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_rewardSource","type":"address"},{"internalType":"address","name":"_shareToken","type":"address"},{"internalType":"address","name":"_nextPool","type":"address"},{"internalType":"uint64","name":"_epoch","type":"uint64"},{"internalType":"uint64","name":"_shareReleaseEpoch","type":"uint64"},{"internalType":"bool","name":"_isFromTicket","type":"bool"},{"internalType":"bool","name":"_enableRoundOrder","type":"bool"}],"name":"configure","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint128","name":"_round","type":"uint128"}],"name":"countRoundOrder","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"countUserOrder","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"dev","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"enableRoundOrder","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"epoch","outputs":[{"internalType":"uint64","name":"","type":"uint64"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"feeRate","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getBalance","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_amount","type":"uint128"}],"name":"getBuyTokenBalance","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_orderId","type":"uint128"}],"name":"getOrderResult","outputs":[{"components":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint128","name":"orderId","type":"uint128"},{"internalType":"uint64","name":"roundNumber","type":"uint64"},{"internalType":"uint64","name":"startTime","type":"uint64"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"},{"internalType":"uint128","name":"claimShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimedShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimShareAvaliable","type":"uint128"}],"internalType":"struct GamePoolActivity.OrderResult","name":"","type":"tuple"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_strategySn","type":"uint128"}],"name":"getRate","outputs":[{"components":[{"internalType":"uint128","name":"score","type":"uint128"},{"internalType":"uint128","name":"score1","type":"uint128"},{"internalType":"uint128","name":"score2","type":"uint128"},{"internalType":"uint128","name":"score3","type":"uint128"}],"internalType":"struct GamePoolActivity.Rate","name":"","type":"tuple"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint64","name":"","type":"uint64"}],"name":"historys","outputs":[{"internalType":"uint128","name":"ticketTotal","type":"uint128"},{"internalType":"uint128","name":"rewardTotal","type":"uint128"},{"internalType":"uint128","name":"strategySn","type":"uint128"},{"internalType":"uint64","name":"startTime","type":"uint64"},{"internalType":"uint64","name":"releaseBlockStart","type":"uint64"},{"internalType":"uint64","name":"releaseBlockEnd","type":"uint64"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"initialize","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"isFromTicket","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_round","type":"uint128"},{"internalType":"uint128","name":"_start","type":"uint128"},{"internalType":"uint128","name":"_end","type":"uint128"}],"name":"iterateReverseRoundOrders","outputs":[{"components":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint128","name":"orderId","type":"uint128"},{"internalType":"uint64","name":"roundNumber","type":"uint64"},{"internalType":"uint64","name":"startTime","type":"uint64"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"},{"internalType":"uint128","name":"claimShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimedShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimShareAvaliable","type":"uint128"}],"internalType":"struct GamePoolActivity.OrderResult[]","name":"list","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint128","name":"_start","type":"uint128"},{"internalType":"uint128","name":"_end","type":"uint128"}],"name":"iterateReverseUserOrders","outputs":[{"components":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint128","name":"orderId","type":"uint128"},{"internalType":"uint64","name":"roundNumber","type":"uint64"},{"internalType":"uint64","name":"startTime","type":"uint64"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"},{"internalType":"uint128","name":"claimShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimedShareAmount","type":"uint128"},{"internalType":"uint128","name":"claimShareAvaliable","type":"uint128"}],"internalType":"struct GamePoolActivity.OrderResult[]","name":"list","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"nextPool","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"orders","outputs":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint64","name":"roundNumber","type":"uint64"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint128","name":"claimedShareAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"paused","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"rewardSource","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"","type":"uint128"},{"internalType":"uint256","name":"","type":"uint256"}],"name":"roundOrders","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"_rate","type":"uint128"}],"name":"setFeeRate","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"components":[{"internalType":"uint128","name":"score","type":"uint128"},{"internalType":"uint128","name":"score1","type":"uint128"},{"internalType":"uint128","name":"score2","type":"uint128"},{"internalType":"uint128","name":"score3","type":"uint128"}],"internalType":"struct GamePoolActivity.Rate","name":"_values","type":"tuple"}],"name":"setRate","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint16","name":"_userMaxScore","type":"uint16"}],"name":"setUserMaxScore","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"_config","type":"address"}],"name":"setupConfig","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"shareReleaseEpoch","outputs":[{"internalType":"uint64","name":"","type":"uint64"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"shareToken","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint128","name":"","type":"uint128"}],"name":"strategies","outputs":[{"internalType":"uint128","name":"score","type":"uint128"},{"internalType":"uint128","name":"score1","type":"uint128"},{"internalType":"uint128","name":"score2","type":"uint128"},{"internalType":"uint128","name":"score3","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"team","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"ticketTotal","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"tickets","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"totalRound","outputs":[{"internalType":"uint64","name":"","type":"uint64"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"totalStrategy","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"components":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"}],"internalType":"struct GamePoolActivity.PlayData[]","name":"datas","type":"tuple[]"}],"name":"uploadBatch","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"components":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint128","name":"ticketAmount","type":"uint128"},{"internalType":"uint16","name":"score","type":"uint16"},{"internalType":"uint16","name":"score1","type":"uint16"},{"internalType":"uint16","name":"score2","type":"uint16"},{"internalType":"uint16","name":"score3","type":"uint16"}],"internalType":"struct GamePoolActivity.PlayData","name":"data","type":"tuple"}],"name":"uploadOne","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint64","name":"_startTime","type":"uint64"},{"internalType":"uint128","name":"_ticketTotal","type":"uint128"}],"name":"uploaded","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"uploader","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"userMaxScore","outputs":[{"internalType":"uint16","name":"","type":"uint16"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"},{"internalType":"uint256","name":"","type":"uint256"}],"name":"userOrders","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"},{"internalType":"uint128","name":"","type":"uint128"}],"name":"userRoundOrderMap","outputs":[{"internalType":"uint128","name":"","type":"uint128"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"_value","type":"uint256"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"reward","type":"uint256"},{"internalType":"uint256","name":"fee","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"stateMutability":"payable","type":"receive"}];
        super(provider, address, abi);
    }
    ...
    async getRate(sn) {
        await this.getShareToken();
        let d = await this.contract.methods.getRate(sn).call();
        d.score = new BigNumber(d.score).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
        d.score1 = new BigNumber(d.score1).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
        d.score2 = new BigNumber(d.score2).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
        d.score3 = new BigNumber(d.score3).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
        return d;
    }

    async getLatestRate() {
        await this.getShareToken();
        let sn = await this.contract.methods.totalStrategy().call();
        const info = await this.contract.methods.getRate(sn).call();
        return {
            score: new BigNumber(info.score).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed(), 
            score1: new BigNumber(info.score1).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed(), 
            score2: new BigNumber(info.score2).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed(), 
            score3: new BigNumber(info.score3).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed()
        };
    }
    ...
    async setRate(param) {
        await this.getShareToken();
        for(let k in param) {
            param[k] = new BigNumber(param[k]).shiftedBy(1 * this.shareTokenInfo.decimals).toFixed();
        }
        return await this.provider.executeContract(this.contract, 'setRate', 0, [param]);
    }
    ...
    async iterateReverseUserOrders(start, end, user) {
        ...
        if(res && res.length > 0) {
            for(let i = 0; i < res.length; i++) {
                ...
                d.shareTokenSymbol = this.shareTokenInfo.symbol;
                d.ticketAmount = new BigNumber(d.ticketAmount).shiftedBy(-1 * this.buyTokenInfo.decimals).toFixed();
                d.claimedShareAmount = new BigNumber(d.claimedAmount).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
                d.claimShareAmount = new BigNumber(d.claimShareAmount).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
                d.claimShareAvaliable = new BigNumber(d.claimShareAvaliable).shiftedBy(-1 * this.shareTokenInfo.decimals).toFixed();
                d.claimShareLock = new BigNumber(d.claimShareAmount).minus(d.claimedShareAmount).minus(d.claimShareAvaliable).toFixed();
                data.push(d);
            }
        }
...
export { ERC20Token, _GameTicket, GameTicket, GameTicket2, GameTicketActivity, GamePool, GamePoolActivity, GamePoolCS, GameTeam, GameAirdrop }
