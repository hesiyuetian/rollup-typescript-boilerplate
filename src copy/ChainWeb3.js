...
class ChainWeb3 {
    ...
    handleNewChain(chainId) {
        ...
        // if(cid == chainWeb3.chainId) return;
        if (!chainId) {
    ...
    handleNewAccounts(newAccounts) {
        console.log('handleNewAccounts:',chainWeb3,  chainWeb3.getNetworkVersion(), newAccounts);
    ...
    async executeContract(contract, methodName, value, params, cb) {
        ...
        if([1,3,4,5].includes(Number(this.chainId))) {
            ...
            // console.log('set gas price:', transParams['gasPrice'])
        }
